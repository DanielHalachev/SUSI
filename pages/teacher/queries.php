...
<main id="queries-main">
    ...
    <div id="criteria-course-characteristics">
        <div id="criteria-course-details">
            <h3 style="display: inline">Критерий за справка: </h3>
            <h3 style="font-weight: bold; display: inline">Имащи като критерий</h3>
